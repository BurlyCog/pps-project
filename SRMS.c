    ...
    {  
        ...
        printf("Marks of student in order:\n");  
    ...
    void find_using_marks()  
    {  
        int id;  
        printf("\n\nYou can find the Students ");  
        printf("who have scored the following marks in any subject");  
        printf("Enter the marks scored in any subject: \n");  
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    printf("who have scored the ");  
                    printf("corresponding marks in a subject are:\n");  
                    printf("The first name of the student is %s\n", st[j].f_name);  
                    printf("The last name of the student is %s\n", st[j].l_name);  
                    printf("The Roll number of the student is %d\n", st[j].r_no);  
                    printf("The CGPA of the student is %f\n", st[j].cgpa);  
    ...
    {  
        ...
        {  
            ...
            case 4:  
                ...
                break;  
            case 5:  
                printf("Enter the new marks from subject 1 to 5\n");  
...
// of students   
    ...
    {   
        ...
        {  
            ...
            printf("\n\nStudent record system in C, using Structures\n""\n1. Add the details of the student\n");  
            ...
            printf(" student by using marks scored\n");  
            ...
            {  
                ...
                case 5:  
                    ...
                    printf("5. Marks scored by the student\n");  
                    update();  
                    break;  
